...
class BookshelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookshelf" do
    assert_difference("Bookshelf.count") do
      post bookshelves_url, params: { bookshelf: { name: @bookshelf.name, user_id: @bookshelf.user_id } }
    end
  ...
  test "should update bookshelf" do
    patch bookshelf_url(@bookshelf), params: { bookshelf: { name: @bookshelf.name, user_id: @bookshelf.user_id } }
